...
namespace PremiumLivingOPS.Views.StatisticalReports
{
    ...
    public partial class ViewReportForm : Form
    {
        ...
        private void RenderAfterService()
        {
            ...
            dgvR.Columns.Add(new DataGridViewTextBoxColumn { Name = "colRStatus",  HeaderText = "STATUS",        FillWeight = 13 });
            ...
            try
            {
                ...
                if (vm.ComplaintRows != null)
                    foreach (var r in vm.ComplaintRows)
                        dgvC.Rows.Add(
                            r.ComplaintDate.ToString("yyyy-MM-dd"),
                            r.ComplaintID,
                            r.CustomerName,
                            r.Subject,
                            r.ComplaintStatus);
        ...
        private void RenderFinance()
        {
            ...
            var dgv = MakeDgv();
            // Payment Method and Status columns are intentionally excluded
            dgv.Columns.Add(new DataGridViewTextBoxColumn { Name = "colDate",    HeaderText = "DATE",             FillWeight = 16 });
            dgv.Columns.Add(new DataGridViewTextBoxColumn { Name = "colTxID",    HeaderText = "TRANSACTION ID",   FillWeight = 22 });
            dgv.Columns.Add(new DataGridViewTextBoxColumn { Name = "colDocType", HeaderText = "DOCUMENT TYPE",    FillWeight = 22 });
            dgv.Columns.Add(new DataGridViewTextBoxColumn { Name = "colTxType",  HeaderText = "TRANSACTION TYPE", FillWeight = 22 });
