...
namespace PremiumLivingOPS.Views.StatisticalReports
{
    ...
    /// ─ KPI pills:  220 × 60, rounded, identical to commit 8d7b970 MakeKpiCard()
    /// ─ DataGridView: identical header / cell / row style to commit 8d7b970 MakeGrid()
    ///
    ...
    public partial class ViewReportForm : Form
    {
        ...
        // ────────────────────────────────────────────────────────────────────
        //  Tab switcher  (mirrors commit 8d7b970 SwitchToReport exactly)
        // ────────────────────────────────────────────────────────────────────
