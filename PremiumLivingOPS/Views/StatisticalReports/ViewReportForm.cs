...
namespace PremiumLivingOPS.Views.StatisticalReports
{
    ...
    public partial class ViewReportForm : Form
    {
        ...
        private static Label MakeLabel(string t)
            => new Label { Text = t, Font = new Font("Segoe UI", 11f, FontStyle.Bold), ForeColor = Color.FromArgb(98, 112, 135), BackColor = Color.Transparent, AutoSize = true, TextAlign = ContentAlignment.MiddleLeft };

        private static DateTimePicker MakeDatePicker(DateTime value)
            => new DateTimePicker { Format = DateTimePickerFormat.Short, Width = 160, Value = value };

        private static ComboBox MakeCbo(string[] items, int width = 185)
        {
            var c = new ComboBox { Font = new Font("Segoe UI", 11f), DropDownStyle = ComboBoxStyle.DropDownList, Width = width };
        ...
        // ════════════════════════════════════════════════════════════════
        //  APPSHELL EVENT HANDLERS  (subscribed ONCE in Designer.cs)
        // ════════════════════════════════════════════════════════════════
