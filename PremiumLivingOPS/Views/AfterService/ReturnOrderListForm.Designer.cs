...
namespace PremiumLivingOPS.Views.AfterService
{
    partial class ReturnOrderListForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ── Search card (height 160) ──────────────────────────────────
            txtKeyword = new TextBox
            {
                Font = new Font("Segoe UI", 12f), BorderStyle = BorderStyle.FixedSingle,
                Dock = DockStyle.Fill, PlaceholderText = "Return ID / Order ID / Customer"
            };
            ...
            var pnlGridBtns = new Panel
            {
                ...
                BackColor = Color.White, Padding = new Padding(16, 8, 16, 8)
            };
        ...
        {
            var b = new Button { Text = text, Font = new Font("Segoe UI", 12f, FontStyle.Bold), ForeColor = Color.White, BackColor = Color.FromArgb(245, 158, 11), FlatStyle = FlatStyle.Flat, Location = loc, Width = w, Height = h, Cursor = Cursors.Hand };
            b.FlatAppearance.BorderSize = 0;
