    ...
    partial class ComplaintListForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtKeyword = new TextBox
            {
                ...
                Dock = DockStyle.Fill, PlaceholderText = "Complaint ID / Order ID / Staff"
            };
            ...
            // ── Add to pnlPage (Fill first, then Top panels bottom→top) ──
            pnlPage.Controls.Add(gridOuter);    // Fill
            pnlPage.Controls.Add(kpiOuter);     // Top (closer to grid)
            pnlPage.Controls.Add(searchOuter);  // Top (top of page)
