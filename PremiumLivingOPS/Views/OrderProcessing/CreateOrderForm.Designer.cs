...
namespace PremiumLivingOPS.Views.OrderProcessing
{
    partial class CreateOrderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tblInfo.Controls.Add(FieldLabel("Customer",   true), 0, 2);
            tblInfo.Controls.Add(FieldLabel("Address ID", true), 1, 2);
            tblInfo.Controls.Add(pnlCustomerPicker,               0, 3);
            ...
            var (pnlInfoOuter, pnlInfoInner) = CardPanel.Create(outerHeight: 800);
            ...
            btnAddItem    = MakePrimaryBtn("➕  Add Item", Point.Empty, ItemBtnW, ItemBtnH);
