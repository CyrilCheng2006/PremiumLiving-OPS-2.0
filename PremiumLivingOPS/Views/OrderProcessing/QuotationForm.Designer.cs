    ...
    partial class QuotationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            cboStatusFilter.Items.AddRange(new object[]
                { "All", "Pending", "Converted", "Rejected" });
            ...
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colQuotationID", HeaderText = "Quotation ID",   FillWeight = 14,
                  SortMode = DataGridViewColumnSortMode.NotSortable });
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colCustomer",    HeaderText = "Customer",        FillWeight = 22,
                  SortMode = DataGridViewColumnSortMode.NotSortable });
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colExpiry",      HeaderText = "Expiry Date",     FillWeight = 13,
                  SortMode = DataGridViewColumnSortMode.NotSortable });
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colTotal",       HeaderText = "Total Amount",    FillWeight = 14,
                  SortMode = DataGridViewColumnSortMode.NotSortable });
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colDeposit",     HeaderText = "Deposit Req.",    FillWeight = 13,
                  SortMode = DataGridViewColumnSortMode.NotSortable });
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colLeadTime",    HeaderText = "Lead Time",       FillWeight = 12,
                  SortMode = DataGridViewColumnSortMode.NotSortable });
            dgvQuotations.Columns.Add(new DataGridViewTextBoxColumn
                { Name = "colStatus",      HeaderText = "Status",          FillWeight = 12,
                  SortMode = DataGridViewColumnSortMode.NotSortable });

            dgvQuotations.SelectionChanged += dgvQuotations_SelectionChanged;

            // ── Header strip (title + toolbar) ───────────────────────────
