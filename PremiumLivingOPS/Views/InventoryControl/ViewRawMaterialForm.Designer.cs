...
namespace PremiumLivingOPS.Views.InventoryControl
{
    partial class ViewRawMaterialForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ── Root panel
            pnlRoot = new Panel { Dock = DockStyle.Fill, BackColor = Color.FromArgb(240, 242, 245), Padding = new Padding(0) };
            ...
            txtSearch = new TextBox
            {
                ...
                Width = 320, Height = 36, Font = new Font("Segoe UI", 11f),
            ...
            {
                Width = 180, Height = 36, DropDownStyle = ComboBoxStyle.DropDownList,
                Font  = new Font("Segoe UI", 11f), Margin = new Padding(0, 0, 10, 0)
            };
            ...
            dgvMaterials.Columns.Add(new DataGridViewTextBoxColumn { Name = "colStockQty",     HeaderText = "STOCK QTY",     FillWeight = 9  });
            dgvMaterials.Columns.Add(new DataGridViewTextBoxColumn { Name = "colStatus",       HeaderText = "STATUS",        FillWeight = 9  });

            var pnlFooter = new Panel
            {
                Dock = DockStyle.Bottom, Height = 56, BackColor = Color.White,
            ...
            innermost.Controls.Add(dgvMaterials);
            ...
            {
                Text = "Products", Font = new Font("Segoe UI", 11f),
                ForeColor = Color.FromArgb(98, 112, 135), BackColor = Color.White,
                FlatStyle = FlatStyle.Flat, Width = 160, Height = 44,
                Dock = DockStyle.Left, Cursor = Cursors.Hand
            };
            btnTabProduct.FlatAppearance.BorderSize = 0;
            btnTabRawMaterial = new Button
            {
                Text = "Raw Materials", Font = new Font("Segoe UI", 11f, FontStyle.Bold),
                ForeColor = Color.FromArgb(47, 111, 237), BackColor = Color.White,
                FlatStyle = FlatStyle.Flat, Width = 160, Height = 44,
                Dock = DockStyle.Left, Cursor = Cursors.Hand
            };
        ...
        private static Button MakePrimaryBtn(string text)
        {
            var b = new Button
            {
                ...
                FlatStyle = FlatStyle.Flat, Height = 36, AutoSize = true,
                Padding = new Padding(16, 0, 16, 0), Cursor = Cursors.Hand
            };
