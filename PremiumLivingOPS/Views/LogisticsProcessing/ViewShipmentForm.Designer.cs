...
namespace PremiumLivingOPS.Views.LogisticsProcessing
{
    partial class ViewShipmentForm
    {
        ...
        {
            // ── Form settings ─────────────────────────────────────────────────
            this.Text                = "Logistics Processing – View Shipment";
            ...
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            var (filterOuter, filterInner) = CardPanel.Create(outerHeight: 76, outerPadding: new Padding(20, 8, 20, 8));
            filterOuter.Dock = DockStyle.Top;

            lblSearchHint   = new Label  { Text = "Search:",  AutoSize = true, TextAlign = ContentAlignment.MiddleLeft };
            txtSearch       = new TextBox { Size = new Size(220, 28) };
            lblStatusFilter = new Label  { Text = "Status:",  AutoSize = true, TextAlign = ContentAlignment.MiddleLeft };
            ...
            lblFromDate = new Label { Text = "From:", AutoSize = true, TextAlign = ContentAlignment.MiddleLeft };
            ...
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            var (gridOuter, gridInner) = CardPanel.Create(outerHeight: 380, outerPadding: new Padding(20, 8, 20, 8));
            ...
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            // Card 4 — Shipment Detail (toggled visible on row selection)
            // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            var (detailOuter, detailInner) = CardPanel.Create(outerHeight: 460, outerPadding: new Padding(20, 8, 20, 8));
            ...
            var (dnOuter, dnInner) = CardPanel.Create(outerHeight: 106, outerPadding: new Padding(12, 4, 12, 4));
            pnlDNOuter      = dnOuter;
            ...
            string lbl1, Label val1, string lbl2, Label val2)
        {
            ...
            val1.ForeColor = Color.FromArgb(15, 31, 53);
            val1.Font      = new Font("Segoe UI", 10f, FontStyle.Bold);
            val2.Text      = "—"; val2.AutoSize = true;
            val2.ForeColor = Color.FromArgb(15, 31, 53);
